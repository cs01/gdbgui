...
class BinaryLoader extends React.Component {
        ...
        <div className="input-group input-group-sm">
          <div className="dropdown input-group-btn">
            ...
            <ul className="dropdown-menu">
              ...
              <li>
                <a className="pointer" onClick={() => this.setState({target_type: TARGET_TYPES.server})}>
                  Connect to gdbserver
                </a>
              </li>
              <li>
                <a className="pointer" onClick={() => this.setState({target_type: TARGET_TYPES.process})}>
                  Attach to Process
                </a>
              </li>
            </ul>
  ...
  _add_user_input_to_history(binary_and_args) {
    ...
    if (num_gdbgui_sessions >= 9 && initial_data.p !== 'd2b6fad22b1e05178f4888fcb461a481e8e0e3b7a28b6bc60b1df7eb286a77dc') {
      /* global initial_data */
