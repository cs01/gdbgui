...
class GdbMiOutput extends React.Component {
  ...
  constructor() {
    ...
    this._debounced_scroll_to_bottom = _.debounce(this._scroll_to_bottom.bind(this), 300, {
      leading: true,
    })
  }
  render() {
    return (
      <div>
        <button title="clear all mi output" className="pointer btn btn-default btn-xs" onClick={() => store.set('gdb_mi_output', [])}>
          clear output
