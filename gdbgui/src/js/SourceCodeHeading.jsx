...
class SourceCodeHeading extends React.Component {
  constructor() {
    super()
    store.connectComponentState(this, ['fullname_to_render', 'paused_on_frame', 'line_of_source_to_flash', 'source_code_selection_state'])
  }
  render() {
    let line
    ...
    return <FileLink fullname={this.state.fullname_to_render} file={this.state.fullname_to_render} line={line} num_lines={num_lines} />
  }
}
