...
class GdbConsoleContainer extends React.Component {
  constructor() {
    ...
    store.connectComponentState(this, ['gdb_console_entries', 'gdb_autocomplete_options'], this._store_change_callback.bind(this))
  }
  ...
  get_previous_command_from_history = () => {
    this.setState({
      current_command_input: CommandHistory.get_previous_command(this.state.current_command_input) || this.state.current_command_input,
    })
  }

  get_next_command_from_history = () => {
    this.setState({
      current_command_input: CommandHistory.get_next_command(this.state.current_command_input) || this.state.current_command_input,
    })
  }
  ...
  render() {
    const {gdb_console_entries, current_command_input, gdb_autocomplete_options} = this.state
