...
class Threads extends React.Component {
  constructor() {
    super()
    store.connectComponentState(this, ['threads', 'current_thread_id', 'stack', 'selected_frame_num'])
  }
  ...
  static get_thread_header(thread, is_current_thread_being_rendered) {
    ...
    if (is_current_thread_being_rendered) {
      cls = 'bold'
      status = (
        <span className="label label-primary" title="This thread is selected. Variables can be inspected for the current frame of this thread.">
          selected
        </span>
      )
    } else {
