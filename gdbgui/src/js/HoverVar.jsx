...
class HoverVar extends React.Component {
    ...
    render(){
        ...
        this.obj = obj
        if (obj){
            let style = {position: 'absolute', left: HoverVar.left + 'px', top: HoverVar.top + 'px', 'backgroundColor': 'white'}
            return <div style={style} id='hovervar'>
                    <GdbVariable obj={obj} key={obj.expression} expression={obj.expression} expr_type='hover' />
                </div>
        }else{
