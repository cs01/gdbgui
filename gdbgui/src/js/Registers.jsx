...
class Registers extends React.Component {
  ...
  render() {
    ...
    if (
      (num_register_names > 0 && num_register_values > 0 && num_register_names !== num_register_values) ||
      (num_register_names === 0 && register_name_fetch_count <= MAX_REGISTER_NAME_FETCH_COUNT)
    ) {
      ...
      for (let i in register_names) {
        ...
        register_table_data.push([name, disp_hex_val, disp_dec_val, register_description])
      }
