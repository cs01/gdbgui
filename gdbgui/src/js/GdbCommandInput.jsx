...
class GdbCommandInput extends React.Component {
  ...
  render() {
    const {on_current_command_input_change, current_command_input, clear_console} = this.props
        ...
        <table>
          <tbody>
            <tr>
              ...
              <td>
                <span onClick={clear_console} className="glyphicon glyphicon-ban-circle clear_console" title="clear console" />
              </td>
            </tr>
          </tbody>
        </table>
