...
const Handlers = {
  ...
  onProgramStopped: function (stoppedDetails: GdbProgramStopped) {
    ...
    store.set<typeof store.data.stoppedDetails>(
      'stoppedDetails',
      stoppedDetails
    )
  ...
  addGdbGuiConsoleEntries: function (
    entries: any,
    entryType: GdbGuiConsoleEntry
  ) {
  ...
  setGdbBinaryAndArguments(binary: string, args: string) {
    ...
    store.set<typeof store.data.inferior_binary_path>(
